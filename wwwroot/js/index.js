...
},{"./Errors":7,"./HttpClient":9,"./NodeHttpClient":19,"./XhrHttpClient":25}],6:[function(require,module,exports){
"use strict";
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./TextMessageFormat":22,"./Utils":23,"buffer":2}],9:[function(require,module,exports){
"use strict";
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
...
},{"./DefaultHttpClient":5,"./ILogger":14,"./ITransport":15,"./LongPollingTransport":18,"./ServerSentEventsTransport":20,"./Utils":23,"./WebSocketTransport":24}],11:[function(require,module,exports){
"use strict";
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
...
},{"./HandshakeProtocol":8,"./IHubProtocol":13,"./ILogger":14,"./Subject":21,"./Utils":23}],12:[function(require,module,exports){
"use strict";
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
var __assign = (this && this.__assign) || Object.assign || function(t) {
...
},{"./DefaultReconnectPolicy":6,"./HttpConnection":10,"./HubConnection":11,"./ILogger":14,"./JsonHubProtocol":16,"./Loggers":17,"./Utils":23}],13:[function(require,module,exports){
"use strict";
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./AbortController":4,"./Errors":7,"./ILogger":14,"./ITransport":15,"./Utils":23}],19:[function(require,module,exports){
(function (Buffer){
"use strict";
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
...
},{"./Errors":7,"./HttpClient":9,"./ILogger":14,"./Utils":23,"buffer":2}],20:[function(require,module,exports){
"use strict";
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
...
},{"./ILogger":14,"./Loggers":17}],24:[function(require,module,exports){
"use strict";
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
...
},{"./ILogger":14,"./ITransport":15,"./Utils":23}],25:[function(require,module,exports){
"use strict";
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
var __extends = (this && this.__extends) || (function () {
...
},{"./Errors":7,"./HttpClient":9,"./ILogger":14}],26:[function(require,module,exports){
"use strict";
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./DefaultHttpClient":5,"./Errors":7,"./HttpClient":9,"./HubConnection":11,"./HubConnectionBuilder":12,"./IHubProtocol":13,"./ILogger":14,"./ITransport":15,"./JsonHubProtocol":16,"./Loggers":17,"./Subject":21}],27:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
...
function addItem(pokerItem) {
    ...
    switch (pokerItem.itemType) {
        case poker_1.PokerItemType.StartDoing:
            document.getElementById("startDoingList").appendChild(li);
            break;
        case poker_1.PokerItemType.StopDoing:
            document.getElementById("stopDoingList").appendChild(li);
            break;
        case poker_1.PokerItemType.ContinueDoing:
            document.getElementById("continueDoingList").appendChild(li);
            break;
    }
}
var client = new retro_1.RetroClient();
document.getElementById("sendButton").addEventListener("click", function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var user, message, category, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, client.addActionAsync(parseInt(category), user, message)];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
...
document.getElementById("clearButton").addEventListener("click", function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, client.clearStateAsync()];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        try {
            ...
            client.registerItemCallback("StateReceived", function (itemsState) {
                return __awaiter(this, void 0, void 0, function () {
                    var startDoingList, stopDoingList, continueDoingList, _i, itemsState_1, item;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                startDoingList = document.getElementById("startDoingList");
                                stopDoingList = document.getElementById("stopDoingList");
                                continueDoingList = document.getElementById("continueDoingList");
                                return [4 /*yield*/, clearList(startDoingList)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, clearList(stopDoingList)];
                            case 2:
                                _a.sent();
                                return [4 /*yield*/, clearList(continueDoingList)];
                            case 3:
                                _a.sent();
                                for (_i = 0, itemsState_1 = itemsState; _i < itemsState_1.length; _i++) {
                                    item = itemsState_1[_i];
                                    addItem(item);
                                }
                                return [2 /*return*/];
                        }
            ...
            client.connection.start().then(function (fulfilled) { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    //  console.log(await client.requestStateAsync());
                    console.log("Successfully connected!");
                    return [2 /*return*/];
                });
            }); }, function (rejected) { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
...
},{"./poker":28,"./retro":29}],28:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
var PokerItemType;
(function (PokerItemType) {
    PokerItemType[PokerItemType["ContinueDoing"] = 3] = "ContinueDoing";
    PokerItemType[PokerItemType["StartDoing"] = 1] = "StartDoing";
    PokerItemType[PokerItemType["StopDoing"] = 2] = "StopDoing";
    PokerItemType[PokerItemType["Points"] = 4] = "Points";
})(PokerItemType || (PokerItemType = {}));
exports.PokerItemType = PokerItemType;
var PokerClient = /** @class */ (function () {
    function PokerClient(hubName) {
    ...
    PokerClient.prototype.clearStateAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connection.invoke("ClearBoard").then(function (resp) {
    ...
    PokerClient.prototype.submitItemAsync = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connection.invoke("SubmitItem", item).then(function (resp) {
                            console.log(resp);
    ...
    PokerClient.prototype.registerItemCallback = function (eventName, callback) {
...
},{"@microsoft/signalr":26}],29:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
...
var poker_1 = require("./poker");
var RetroItemType;
(function (RetroItemType) {
    RetroItemType[RetroItemType["StartDoing"] = 1] = "StartDoing";
    RetroItemType[RetroItemType["StopDoing"] = 2] = "StopDoing";
    RetroItemType[RetroItemType["ContinueDoing"] = 3] = "ContinueDoing";
})(RetroItemType || (RetroItemType = {}));
exports.RetroItemType = RetroItemType;
var RetroClient = /** @class */ (function (_super) {
    __extends(RetroClient, _super);
    function RetroClient() {
        return _super.call(this, "retro") || this;
    }
    RetroClient.prototype.addActionAsync = function (itemType, user, message) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.submitItemAsync({ itemType: itemType, value: message, user: user })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    RetroClient.prototype.addContinueDoingAsync = function (user, message) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.addActionAsync(poker_1.PokerItemType.ContinueDoing, user, message)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    RetroClient.prototype.addStartDoingAsync = function (user, message) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.addActionAsync(poker_1.PokerItemType.StartDoing, user, message)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    RetroClient.prototype.addStopDoingAsync = function (user, message) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.addActionAsync(poker_1.PokerItemType.StopDoing, user, message)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
